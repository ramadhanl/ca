                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              while ($row = $result->fetch_array(MYSQLI_BOTH))
                              {
                                  ...
                                  echo('<td>'); echo ('
                                    <div>
                                        <a href="');echo base_url(); echo "admin/"; echo('"><button class="btn btn-success btn-xs fa fa-check"></button></a>
                                         - 
                                        <a href="');echo base_url(); echo "admin/"; echo('"><button class="btn btn-danger btn-xs fa fa-trash-o"></button></a>
                                    </div>
                                    '); echo('</td></tr>');
                              }
                              ?>
